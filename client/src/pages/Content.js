      ...
      <div className="content-wrap">
        ...
        <ContentConsole>
          <div>
            <ContentFieldBox>
              ...
              <p>
                <span>
                  {contentData.endDateTime &&
                    cutSeconds(contentData.endDateTime)}
                </span>
            ...
            <ContentFieldBox>
              ...
              <p>
                {contentData.deliveryPrice &&
                  `${unitCalc(contentData.deliveryPrice)}원/${
                    contentData.totalPeopleCount
                  }명 = ${unitCalc(
                    contentData.deliveryPrice / contentData.totalPeopleCount
                  )}원`}
              </p>
            </ContentFieldBox>
          </div>
        ...
        <ContentArea>
          ...
          <ContentAreaBox>
            ...
            <FriendsMenu>
              {contentData.menus &&
                contentData.menus.map((item, idx) => <li key={idx}>{item.name}</li>)}
            </FriendsMenu>
          ...
          <ContentAreaBox>
            ...
            <MapContainer
              ...
              lat={
                ...
                contentData.pickupLocation.latitude
              }
              lng={
                contentData.pickupLocation &&
                contentData.pickupLocation.longitude
              }
            />
          </ContentAreaBox>
          <ContentAreaBox>
